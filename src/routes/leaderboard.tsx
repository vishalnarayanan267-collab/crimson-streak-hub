...
function Leaderboard() {
  ...
  const ranked = [...store.users].sort((a, b) => b.points - a.points);
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 pt-4 lg:px-10 lg:pt-10">
      ...
      <section className="mt-6 grid grid-cols-3 gap-3 animate-rise">
        {[top[1], top[0], top[2]].filter(Boolean).map((u, i) => {
          const rank = u === top[0] ? 1 : u === top[1] ? 2 : 3;
          ...
          return (
            <div key={u.id} className="flex flex-col items-center">
              ...
              <div className="mt-2 truncate text-xs font-semibold text-foreground">{u.name}</div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-end gap-1 text-right">
                ...
                <span className="text-sm font-bold tabular-nums text-foreground">{u.streak}</span>
              </div>
